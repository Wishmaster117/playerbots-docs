...
1. List the main folders and their roles (e.g. `src/Bot`, `src/Ai`, `src/Mgr`, etc.).
2. Write a small glossary (bot, master, random bot, strategy, action, engine, etc.).
3. Define a common section format:
   - Role
   - Key APIs / classes
   - Managed data
   - Extension points
