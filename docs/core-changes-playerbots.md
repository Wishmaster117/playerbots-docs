...
> Scope: this is **not** a full playerbots feature doc. This page only covers the *core-level integration points* that the module relies on.
...
Ensure modules links against mysql (needed by additional DB wiring)
